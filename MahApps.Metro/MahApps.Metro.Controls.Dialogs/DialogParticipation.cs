...
namespace MahApps.Metro.Controls.Dialogs
{
	public static class DialogParticipation
	{
		...
		public static readonly DependencyProperty RegisterProperty = DependencyProperty.RegisterAttached("Register", typeof(object), typeof(DialogParticipation), new PropertyMetadata(null, RegisterPropertyChangedCallback));
