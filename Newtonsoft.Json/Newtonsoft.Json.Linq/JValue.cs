...
namespace Newtonsoft.Json.Linq
{
	public class JValue : JToken, IEquatable<JValue>, IFormattable, IComparable, IComparable<JValue>, IConvertible
	{
		...
		public override Task WriteToAsync(JsonWriter writer, CancellationToken cancellationToken, params JsonConverter[] converters)
		{
			...
			{
				object value;
				if ((value = _value) is DateTimeOffset)
				{
		...
		private static int CompareBigInteger(BigInteger i1, object i2)
		{
			...
			object obj;
			if ((obj = i2) is decimal)
			{
				decimal num2 = (decimal)obj;
				return decimal.Zero.CompareTo(Math.Abs(num2 - Math.Truncate(num2)));
			}
		...
		internal static int Compare(JTokenType valueType, object objA, object objB)
		{
			...
			if (objA != null)
			{
				...
				{
					object obj;
					if ((obj = objA) is BigInteger)
					{
						BigInteger i = (BigInteger)obj;
						return CompareBigInteger(i, objB);
					}
					if ((obj = objB) is BigInteger)
					{
						BigInteger i2 = (BigInteger)obj;
				...
				case JTokenType.Float:
				{
					...
					if ((obj = objA) is BigInteger)
					{
						BigInteger i3 = (BigInteger)obj;
						return CompareBigInteger(i3, objB);
					}
					if ((obj = objB) is BigInteger)
					{
						BigInteger i4 = (BigInteger)obj;
				...
				{
					object obj;
					if ((obj = objA) is DateTime)
					{
						DateTime dateTime = (DateTime)obj;
						DateTime value3 = (!((obj = objB) is DateTimeOffset)) ? Convert.ToDateTime(objB, CultureInfo.InvariantCulture) : ((DateTimeOffset)obj).DateTime;
						return dateTime.CompareTo(value3);
					}
					DateTimeOffset dateTimeOffset = (DateTimeOffset)objA;
					DateTimeOffset other = ((obj = objB) is DateTimeOffset) ? ((DateTimeOffset)obj) : new DateTimeOffset(Convert.ToDateTime(objB, CultureInfo.InvariantCulture));
		...
		public override void WriteTo(JsonWriter writer, params JsonConverter[] converters)
		{
			...
			case JTokenType.Integer:
			{
				...
				else if ((value = _value) is long)
				{
					long value7 = (long)value;
					writer.WriteValue(value7);
				}
				else if ((value = _value) is ulong)
				{
					ulong value8 = (ulong)value;
					writer.WriteValue(value8);
				}
				else if ((value = _value) is BigInteger)
				{
					BigInteger bigInteger = (BigInteger)value;
			...
			case JTokenType.Float:
			{
				...
				else if ((value = _value) is double)
				{
					double value3 = (double)value;
					writer.WriteValue(value3);
				}
				else if ((value = _value) is float)
				{
					float value4 = (float)value;
