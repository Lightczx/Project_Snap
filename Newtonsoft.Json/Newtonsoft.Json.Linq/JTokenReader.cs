	...
	public class JTokenReader : JsonReader, IJsonLineInfo
	{
		...
		public override bool Read()
		{
			if (base.CurrentState != 0)
			{
				...
				if ((jContainer = (_current as JContainer)) != null && _parent != jContainer)
				{
		...
		private void SetToken(JToken token)
		{
			...
			case JTokenType.Uri:
			{
				...
				Uri uri;
				SetToken(JsonToken.String, ((object)(uri = (value as Uri)) != null) ? uri.OriginalString : SafeToString(value));
				break;
			}
