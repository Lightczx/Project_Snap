...
namespace Newtonsoft.Json.Utilities
{
	internal static class ReflectionUtils
	{
		...
		public static Attribute[] GetAttributes(object attributeProvider, Type attributeType, bool inherit)
		{
			...
			{
				Type type;
				if ((object)(type = (attributeProvider as Type)) != null)
				{
					Type type2 = type;
					return ((attributeType != null) ? type2.GetCustomAttributes(attributeType, inherit) : type2.GetCustomAttributes(inherit)).Cast<Attribute>().ToArray();
				}
				Assembly assembly;
				if ((object)(assembly = (attributeProvider as Assembly)) != null)
				{
				...
				if ((object)(memberInfo = (attributeProvider as MemberInfo)) != null)
				{
					MemberInfo element2 = memberInfo;
					if (!(attributeType != null))
					{
				...
				Module module;
				if ((object)(module = (attributeProvider as Module)) != null)
				{
					Module element3 = module;
					if (!(attributeType != null))
					{
				...
				{
					ParameterInfo element4 = parameterInfo;
					if (!(attributeType != null))
					{
