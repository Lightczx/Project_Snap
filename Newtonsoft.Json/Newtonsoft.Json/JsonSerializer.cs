	...
	public class JsonSerializer
	{
		...
		public virtual SerializationBinder Binder
		{
			get
			{
				...
				if ((result = (_serializationBinder as SerializationBinder)) != null)
				{
					return result;
				}
				SerializationBinderAdapter serializationBinderAdapter;
				if ((serializationBinderAdapter = (_serializationBinder as SerializationBinderAdapter)) != null)
				{
		...
		private void SetupReader(JsonReader reader, out CultureInfo previousCulture, out DateTimeZoneHandling? previousDateTimeZoneHandling, out DateParseHandling? previousDateParseHandling, out FloatParseHandling? previousFloatParseHandling, out int? previousMaxDepth, out string previousDateFormatString)
		{
			...
			if ((jsonTextReader = (reader as JsonTextReader)) != null && jsonTextReader.PropertyNameTable == null && (defaultContractResolver = (_contractResolver as DefaultContractResolver)) != null)
			{
		...
		private void ResetReader(JsonReader reader, CultureInfo previousCulture, DateTimeZoneHandling? previousDateTimeZoneHandling, DateParseHandling? previousDateParseHandling, FloatParseHandling? previousFloatParseHandling, int? previousMaxDepth, string previousDateFormatString)
		{
			...
			JsonTextReader jsonTextReader;
			DefaultContractResolver defaultContractResolver;
			if ((jsonTextReader = (reader as JsonTextReader)) != null && jsonTextReader.PropertyNameTable != null && (defaultContractResolver = (_contractResolver as DefaultContractResolver)) != null && jsonTextReader.PropertyNameTable == defaultContractResolver.GetNameTable())
			{
